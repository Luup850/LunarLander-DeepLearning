...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(
        ...
        *,
        ...
        self.lander.color1 = (128, 128, 128)
        self.lander.color2 = (50, 50, 50)
    ...
    def step(self, action):
        ...
        reward -= (
            m_power * self.fuel_penalty
        )  # less fuel spent is better, about -30 for heuristic landing
        reward -= s_power * (self.fuel_penalty / 10)
    ...
    def render(self):
        ...
        if self.color_scheme == 'earth':
            pygame.draw.rect(self.surf, (72, 111, 56), self.surf.get_rect())
        elif self.color_scheme == 'mars':
            pygame.draw.rect(self.surf, (168, 73, 39), self.surf.get_rect())
        elif self.color_scheme == 'moon':
        ...
        for p in self.sky_polys:
            ...
            if self.color_scheme == 'earth':
                pygame.draw.polygon(self.surf, (115, 215, 255), scaled_poly)
                gfxdraw.aapolygon(self.surf, scaled_poly, (115, 215, 255))
            elif self.color_scheme == 'mars':
                pygame.draw.polygon(self.surf, (255, 0, 0), scaled_poly)
                gfxdraw.aapolygon(self.surf, scaled_poly, (255, 0, 0))
            elif self.color_scheme == 'moon':
